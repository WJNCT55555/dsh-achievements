...
export declare function AchievementsSection({ list, deepState, setDeepInsights, t }: AchievementsSectionInjected & PropsLocale<'achievements'>): import("react").JSX.Element;
