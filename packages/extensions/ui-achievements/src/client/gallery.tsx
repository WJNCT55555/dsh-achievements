...
export function GalleryOverlay({ useSnapshot, close, list, deepState, setDeepInsights, rates, telemetryState, setTelemetry, clear, heatmap, t }: GalleryOverlayInjected & PropsLocale<'achievements'>) {
